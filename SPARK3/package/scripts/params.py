...
if stack_version_formatted and check_stack_feature(StackFeature.ROLLING_UPGRADE, stack_version_formatted):
  ...
  spark_conf = format("{stack_root}/3.1.4.0-315/{component_directory}/conf")
  spark_log_dir = config['configurations']['spark3-env']['spark_log_dir']
  spark_pid_dir = status_params.spark_pid_dir
  spark_home = format("{stack_root}/3.1.4.0-315/{component_directory}")
...
spark_hadoop_lib_native = format("{stack_root}/3.1.4.0-315/hadoop-client/lib/native:{stack_root}/3.1.4.0-315/hadoop-client/lib/native/Linux-amd64-64")
...
hive_schematool_bin = format('{stack_root}/3.1.4.0-315/{hive_component_directory}/bin')
